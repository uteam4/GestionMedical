...
public class Administrateur extends javax.swing.JFrame {
       ...
       /* jTable1.setModel(new javax.swing.table.DefaultTableModel(
        ...
        rechercher.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	...
            	if (pos<0){
            	 JOptionPane.showMessageDialog(Administrateur.this, "Aucun élément trouvé");
            	 
            	}
            	else{
            		JOptionPane.showMessageDialog(Administrateur.this, "Position: " + pos);            		
	...
	public static void setId_fiche(int id_fiche) {
		Administrateur.id_fiche = id_fiche;
	}
