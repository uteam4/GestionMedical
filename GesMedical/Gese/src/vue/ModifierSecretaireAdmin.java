...
public class ModifierSecretaireAdmin extends javax.swing.JFrame {
String[] tab;
    
    public ModifierSecretaireAdmin(String[] tab) {
    	this.tab=tab;
        initComponents();
    }

    public ModifierSecretaireAdmin() {
    ...
    private void initComponents() {
        ...
        setTitle("Formulaire secretaire");
        ...
        jLabel1.setText("FORMULAIRE DE MODIFICATION SECRETAIRE");
        ...
        enregister.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
	           ...
	           fc.updateSec(nom_sec, prenom_sec, login_sec, motdepasse_sec, a.prendreid());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierSecretaireAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifierSecretaireAdmin().setVisible(true);
            }
        });
    }
